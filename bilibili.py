...
#身份认证
COOKIE = "SESSDATA=6a9aad97%2C1766123697%2Ca801f%2A62CjBuyykoevdRVH8u4GokSiGwCaTX7EHbvhNuyl9oBSq2kz5zA8v1DnmuizzG2aCFBKUSVnN2QzZpbmptVlpZajJHWElnaXV2SC15aE81cVpISHvXU0pfRVNYYkdwMW5ZOVJRUGpDMThWRkZid2gyb1YyM1RJdHJWV1BHLVp1clIyb0NteDBxWkRRIIEC; buvid3=078B37F8-2329-7FEC-8B95-A425D0A1BC2757995infoc"  # ⚠️填你自己浏览器复制的 Cookie（已登录 B 站）
HEADERS = {
...
NEGATIVE_KEYWORDS = {
    "涉政有害": ["反动", "颠覆", "分裂", "台独", "港独", "疆独", "藏独", "独裁", "暴政", "专制",
                ...
                "强拆", "黑警", "维稳", "退党", "集体请愿", "境外网站", "网信办", "删帖", "封号"],
